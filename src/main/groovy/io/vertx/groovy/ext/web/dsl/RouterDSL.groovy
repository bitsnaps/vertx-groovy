...
//import io.vertx.groovy.ext.web.handler.CookieHandler //deprecated https://github.com/vert-x3/wiki/wiki/3.8.1-Deprecations-and-breaking-changes
//import io.vertx.groovy.ext.web.handler.TemplateHandler
//import io.vertx.groovy.ext.web.handler.sockjs.SockJSHandler // deprecated https://github.com/vert-x3/wiki/wiki/3.8.2-Deprecations-and-breaking-changes
...
//		router.route(path).handler(sockJS)
		router.mountSubRouter(path, SockJS.create(vertx).bridge(closure))
	}
